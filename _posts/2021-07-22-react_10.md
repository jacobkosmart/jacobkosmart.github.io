  ...
  return (
    <div>
      <Nav variant="tabs" defaultActiveKey="link-0">
        <Nav.Item>
          <Nav.Link eventKey="link-0" onClick={()=>{ editOnoff(false); editTap(0) }}>Active</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-1" onClick={()=>{ editOnoff(false); editTap(1) }}>Option 2</Nav.Link>
        </Nav.Item>
      </Nav>
